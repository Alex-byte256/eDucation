import {ItailWindSliderElementContent} from "./types";

export function useTailWindSliderContent() {

    const tailWindSliderContent: ItailWindSliderElementContent[] = [
        {
            id: 1,
            title: "title1",
            describe: 'describe1',
